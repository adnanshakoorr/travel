...
class General extends CI_Model {
	...
	{		
      ...
      $this->db->join($data['join_table'],$data['join'],$data['join_type']);			
		...
		if(isset($data['where_in_col_name']) && isset($data['where_in_array']) && !empty($data['where_in_col_name']) && !empty($data['where_in_array'])){
			$this->db->where_in($data['where_in_col_name'],$data['where_in_array']);
		}
