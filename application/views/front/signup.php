<!doctype html>
    ...
    <head>
        ...
        <title>Signup - Travel Dream</title>
                            ...
                            <div class="login-inner-form">
                                <form action="<?= base_url('signup/register');?>" method="post">
                                    ...
                                    <div class="form-group form-box">
                                        <input name="fn" type="text" class="form-control" placeholder="Full Name" aria-label="Full Name" value="<?php echo set_value('fn'); ?>">
                                        <i class="fa fa-user"></i>
                                        <?php echo form_error('fn', '<div class="error" style="color: aliceblue;">', '</div>'); ?>
                                    </div>

                                    <div class="form-group form-box">
                                        <input name="e" type="email" class="form-control" placeholder="Email Address" aria-label="Email Address" value="<?php echo set_value('e'); ?>">
                                        <i class="fa fa-envelope"></i>
                                        <?php echo form_error('e', '<div class="error" style="color: aliceblue;">', '</div>'); ?>
                                    </div>

                                    <div class="form-group form-box clearfix">
                                        <input name="p" type="password" class="form-control" autocomplete="off" placeholder="Password">
                                        <i class="fa fa-lock"></i>
                                        <?php echo form_error('p', '<div class="error" style="color: aliceblue;">', '</div>'); ?>
                                    </div>

                                    <div class="form-group form-box clearfix">
                                        <input name="cp" type="password" class="form-control" autocomplete="off" placeholder="Confirm Password">
                                        <i class="fa fa-lock"></i>
                                        <?php echo form_error('cp', '<div class="error" style="color: aliceblue;">', '</div>'); ?>
                                    </div>
