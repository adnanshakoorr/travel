...
<div class="content-wrapper">
            ...
            <form role="form" action="<?php echo $action;?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">
                 ...
                 <div class="form-group">
                  <label>Text</label>
                  <textarea type="name" class="form-control editor" id="technology_text" name="technology_text" required><?php echo !empty($record->technology_text)?$record->technology_text:''?></textarea>
                  <?php echo form_error('technology_text'); ?>
                </div>  
                ...
                <div class="form-group">
                  ...
                  <div class="input-group-btn">
                    <div class="image-upload">                      
                      <img src="<?php echo !empty($record->technology_image)?base_url('uploads/technology/').$record->technology_image:base_url('assets/admin/img/placeholder.png')?>">
                      <div class="file-btn">
                        <input type="file" id="technology_image" name="technology_image">
                        <input type="text" id="technology_image" name="technology_image" value="<?php echo !empty($record->technology_image)?$record->technology_image:''?>" hidden>
                        <label class="btn btn-info">Upload</label>
                      </div>
                    </div>
                  </div>
                   <?php echo form_error('technology_image'); ?>                
                 </div>                 
 ...
 <div class="form-group">
                ...
                <input type="name" class="input" id="master_admin_name" name="master_admin_name"  value="<?php echo !empty($record->master_admin_name) ? $record->master_admin_name : '' ?>">
                <?php echo form_error('master_admin_name'); ?>
              </div>

              <div class="form-group">
                <label>User Email</label>
                <input type="name" class="input" id="master_admin_email" name="master_admin_email"  value="<?php echo !empty($record->master_admin_email) ? $record->master_admin_email : '' ?>">
                <?php echo form_error('master_admin_email'); ?>
              </div>

              <div class="form-group">
                <label>User Phone</label>
                <input type="name" class="input" id="master_admin_phone" name="master_admin_phone"  value="<?php echo !empty($record->master_admin_phone) ? $record->master_admin_phone : '' ?>">
               ...
               <div class="form-group">
                ...
                <input type="text"  class="input" id="master_admin_password" name="master_admin_password" value="<?php echo !empty($record->master_admin_password) ? $this->encryption->decrypt($record->master_admin_password) : '' ?>">
              ...
              <div class="form-group">
                ...
                <input type="name"  class="input" id="master_admin_address" name="master_admin_address" value="<?php echo !empty($record->master_admin_address) ? $record->master_admin_address : '' ?>">
              ...
              <div class="form-group">
                ...
                <select rows="6" class="input"  id="master_admin_role" name="master_admin_role">
              ...
              <div class="form-group">
                ...
                <input placeholder="Enter User Name Who Is Creating This Role" type="name"  class="input" id="master_admin_created_by" name="master_admin_created_by" value="<?php echo !empty($record->master_admin_created_by) ? $record->master_admin_created_by : '' ?>">
